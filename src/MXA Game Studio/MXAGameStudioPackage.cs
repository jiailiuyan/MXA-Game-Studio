...
using InsmaSoftware.MXA_Game_Studio.ProjectFlavor;
...
namespace InsmaSoftware.MXA_Game_Studio {
	...
	[Guid(GuidList.guidMXA_Game_StudioPkgString)]
	public sealed class MXAGameStudioPackage : Package {
		/// <summary>
