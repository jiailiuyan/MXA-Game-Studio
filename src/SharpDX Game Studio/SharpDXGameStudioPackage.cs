...
using InsmaSoftware.SharpDX_Game_Studio.ProjectFlavor;
...
namespace InsmaSoftware.SharpDX_Game_Studio {
	...
	[Guid(GuidList.guidSharpDX_Game_StudioPkgString)]
	public sealed class SharpDXGameStudioPackage : Package {
		/// <summary>
		...
		/// </summary>
		public SharpDXGameStudioPackage( ) {
